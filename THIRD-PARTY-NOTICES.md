...
NUFLIX Studio is by Patai Gergely (cobbpg), under MIT. Its template and adapted
transport retain the [NUFLIX notice](experiments/dosvm-nuflix/THIRD-PARTY-NOTICES.md)
...
package is bundled with this firmware. Corresponding firmware source and
build tools are included in this repository.
