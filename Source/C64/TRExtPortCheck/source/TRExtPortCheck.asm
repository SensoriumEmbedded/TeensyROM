...
MsgExtPortCheck:
   !tx ChrReturn, EscC,EscSourcesColor, ChrRvsOn, " TeensyROM External Port Checks ", ChrReturn
   ;expected interfaces:
   ;Active Ethernet connection
   ;SD card with at least 1 file
   ;USB Thumb Drive with at least 1 file
   ;Host computer to monitor USB device port(?)
